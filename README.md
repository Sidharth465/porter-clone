...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/mRLrMwlJ3a)
...
```sh
npx nx serve porter-clone
```

To create a production bundle:

```sh
npx nx build porter-clone
```

To see all available targets to run for a project, run:

```sh
npx nx show project porter-clone
```
